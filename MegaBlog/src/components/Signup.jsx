...
function Signup() {
    ...
    return (
        <div className="flex items-center justify-center w-full py-12 transition-colors duration-300">
            <div className="
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className="relative">
                            <Input
                                ...
                                // password field's password will be visible or not based on that
                                ...
                                {...register("password", {
                                    ...
                                    // This below pattern check for valid passwod format
                                    pattern: {
                                        value: /^(?=.*[A-Z])(?=.*[a-z])(?=.*\d)(?=.*[@$!%*?&])/,
